...
export enum SourceTLD {
  BenjamminsLive = "benjammins.live",
  Empty = "",
...
export enum Description {
  GamingAndComedyGetReadyItSGoingToBeAWildRide = "Gaming and comedy... get ready. It's going to be a wild ride.",
  MostEntertainingStreamerAndContentCreatorGetJammedOn = "Most entertaining streamer and content creator. Get Jammed on!",
  TheOfficialXboxGIFSPageNowWith100MoreMeta = "The official Xbox GIFs page—now with 100% more meta!",
}

export enum DisplayName {
  BenJammins = "BenJammins",
  Coreytonge = "@coreytonge",
  Xbox = "Xbox",
}
